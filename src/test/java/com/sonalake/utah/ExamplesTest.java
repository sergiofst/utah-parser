...
public class ExamplesTest {
    ...
    @Test
    public void testExampleOjpnlPatronal() throws IOException, JAXBException {
        String configResource = "examples/ojpnl_patronal.xml";
        String fileResource = "examples/ojpnl.txt";
